    ...
    <footer style={styles.footer}>
      <div style={styles.topSection}>
        ...
        <div style={styles.section}>
          ...
          <a href="https://www.linkedin.com/in/faizan-khalid-developerp/" target="_blank" rel="noopener noreferrer" style={styles.link}>
            LinkedIn
          </a>
          <a href="https://portfolio-faizan-topaz.vercel.app" target="_blank" rel="noopener noreferrer" style={styles.link}>
            Portfolio
          </a>
          <a href="tel:03029655325" style={styles.link}>
            Phone: 0302 9655325
          </a>
        </div>
      </div>
      ...
      <div style={styles.bottomSection}>
        ...
        <p style={styles.contactLine}>
          Contact: <a href="tel:03029655325" style={styles.nameLink}>0302 9655325</a>
        </p>
      </div>
    </footer>
  );
